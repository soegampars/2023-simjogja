...
gen cons_age_0_4 	= inrange(K6,0,4)
gen cons_age_5_9 	= inrange(K6,5,9)
gen cons_age_10_14 	= inrange(K6,10,14)
...
gen cons_occ_others = target_lf == 1 & target_unemp == 0 & inlist(target_jobstatus,7)
	...
	keep cons_* target_* cat_* weight

	gen year = 2020
	
	save $clean/national_2020_2, replace
...
gen cons_age_0_4 	= inrange(b4_k8,0,4)
gen cons_age_5_9 	= inrange(b4_k8,5,9)
gen cons_age_10_14 	= inrange(b4_k8,10,14)
...
*/
	...
	save $clean/national_2019_2, replace
	
** ANALYSIS

	append using $clean/national_2020_2
