...
## Note March 3, 2023
## Still has problem from the reconstruction of datasets


# Load data ---------------------------------------------------------------

sat <- read.csv("clean/cons_diy_2020_2.csv")
ind <- read.csv("clean/ind_diy_2020_2.csv")
data <- read.csv("clean/target_diy_2020_2.csv")

# Reorder and cleaning variables ------------------------------------------

cons <- select(sat, -c(kelurahan, kecamatan, kab, id, weightsid)) %>%
...
write.csv(data_new, "clean/reweighted_diy_2020_2.csv")

# 2019 PART ---------------------------------------------------------------

# Load data ---------------------------------------------------------------

sat <- read.csv("clean/cons_diy_2019_2.csv")
ind <- read.csv("clean/ind_diy_2019_2.csv")
data <- read.csv("clean/target_diy_2019_2.csv")
...
write.csv(data_new, "clean/reweighted_diy_2019_2.csv")
